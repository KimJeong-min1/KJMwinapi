...
namespace jm
{
	...
	void StageNine::Initialize()
	{
		...
		graphcis::Texture* bg = Resources::Find<graphcis::Texture>(L"BG09");
		bgsr->SetTexture(bg);

		Scene::Initialize();
	}
	void StageNine::Update()
	{
		Scene::Update();
	}
	void StageNine::LateUpdate()
	{
		Scene::LateUpdate();
	...
	void StageNine::OnEnter()
	{
	}
	void StageNine::OnExit()
	{
	}
}