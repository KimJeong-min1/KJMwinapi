...
namespace jm
{
	...
	void StageFive::Initialize()
	{
		...
		graphcis::Texture* bg = Resources::Find<graphcis::Texture>(L"BG05");
		bgsr->SetTexture(bg);

		Scene::Initialize();
	}
	void StageFive::Update()
	{
		Scene::Update();
	}
	void StageFive::LateUpdate()
	{
		Scene::LateUpdate();
	...
	void StageFive::OnEnter()
	{
	}
	void StageFive::OnExit()
	{
	}
}