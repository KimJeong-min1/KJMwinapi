...
namespace jm
{
	...
	void StageThree::Initialize()
	{
		...
		graphcis::Texture* bg = Resources::Find<graphcis::Texture>(L"BG03");
		bgsr->SetTexture(bg);
	...
	void StageThree::Render(HDC hdc)
	{
		Scene::Render(hdc);
	...
	void StageThree::OnEnter()
	{
	}
	void StageThree::OnExit()
	{
	}
}